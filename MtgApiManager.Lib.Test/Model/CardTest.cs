namespace MtgApiManager.Lib.Test.Model
{
    ...
    public class CardTest
    {
        ...
        public void MapCardTest()
        {
            ...
            Assert.Equal(dto.ForeignNames.Length, model.ForeignNames.Count);
            ...
            Assert.Equal(dto.Legalities.Length, model.Legalities.Count);
            ...
            Assert.Equal(dto.Rulings.Length, model.Rulings.Count);
