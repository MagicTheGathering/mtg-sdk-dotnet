...
namespace MtgApiManager.Lib.TestApp.Avalonia.ViewModels;
...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    private ICard? _selectedCardFromList;
    public ICard? SelectedCardFromList
    {
        get => _selectedCardFromList;
        set
        {
            if (SetProperty(ref _selectedCardFromList, value))
            {
    ...
    private ISet? _selectedSetFromList;
    public ISet? SelectedSetFromList
    {
        get => _selectedSetFromList;
        set
        {
            if (SetProperty(ref _selectedSetFromList, value))
            {
    ...
    public MainWindowViewModel(MtgController controller)
    {
    ...
    {
        var cards = await _controller.GetCards(CardSearchString ?? string.Empty);
    ...
    {
        var sets = await _controller.GetSets(SetSearchString ?? string.Empty);
